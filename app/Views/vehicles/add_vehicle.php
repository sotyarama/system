                        ...
                        <div class="row">
                            <div class="col-md-3">
                                ...
                                <div class="form-group row mx-1">
                                    <div class="custom-file">
                                        ...
                                        <label class="custom-file-label" for="vehicle_image">Choose file</label>
                            ...
                            <div class="col-md-5 border-left border-right">
                                <div class="form-group row mx-1">
                                    ...
                                    <input type="text" name="vehicle_name" id="vehicle_name" class="form-control <?= (!empty(validation_show_error('vehicle_name'))) ? 'is-invalid' : null; ?>" value="<?= old('vehicle_name'); ?>" autofocus>
                                    <div class="invalid-feedback">
                                ...
                                <div class="form-group row mx-1">
                                    ...
                                    <textarea name="vehicle_description" id="vehicle_description" class="form-control" rows="3"></textarea>
                                </div>
                            </div>
                            <div class="col-md-4">
                                <div class="form-group row mx-1">
